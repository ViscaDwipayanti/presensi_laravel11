          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('lokasi.index') }}" aria-expanded="false">
                ...
                <span class="hide-menu">Lokasi Presensi</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('kelola_admin.index') }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('admin.ketidakhadiran') }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('rekapitulasi.presensi') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  ...
                  <div class="usersession fs-4">
                    {{ Auth::user()->pegawai->nama_pegawai ?? Auth::user()->role}}
                  </div>
                </a>
