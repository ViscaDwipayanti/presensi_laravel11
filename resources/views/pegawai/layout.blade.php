      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="#" class="text-nowrap logo-img">
            <img src="{{ asset('modern/src/assets/images/logos/logo-prezy.png') }}" width="215" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('rekap_presensi_pegawai.index') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
                <span class="hide-menu">Rekap Presensi</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('ketidakhadiran.index') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-aperture"></i>
                </span>
                <span class="hide-menu">Ketidakhadiran</span>
              </a>
            </li>
          </ul>
        </nav>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  ...
                  @endphp
                  @if ($foto)
                      <img src="{{ asset('storage/' . $foto) }}" alt="Foto Pegawai" width="35" height="35" class="rounded-circle">
                  @else
                      <img src="{{ asset('modern/src/assets/images/profile/user-1.jpg') }}" alt="Foto Default" width="35" height="35" class="rounded-circle">
                  @endif
                  {{-- user login --}}
                  <div class="usersession fs-4">
